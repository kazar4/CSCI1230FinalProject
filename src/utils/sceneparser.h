...
struct RenderShapeData {
    ...
    glm::mat4 inverseCtm; // inverse of the cumulative transformation matrix
    glm::mat3 inverseTranspose; // the inverse of the transpose of the upper left 3x3 of the ctm
};
